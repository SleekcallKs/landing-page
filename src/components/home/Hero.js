...
function Hero() {
    return (
        <div
            className="hero py-12 bg-gradient-to-t from-blue-500 to-purple-700 relative h-full min-h-screen">
            <motion.div
                initial={{ bottom: "-150px", opacity: 0 }}
                whileInView={{ opacity: 1, bottom: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1 }}
                className="hero-content relative md:px-0 px-4 max-w-6xl flex-col lg:flex-row-reverse">
                ...
                <div className="text-center mt-4">
                    ...
                    <div className="flex justify-center gap-8">
                        <Link href="/about-us"><button className="btn text-lg mt-16 px-12   btn-neutral normal-case">Loslegen</button></Link>
